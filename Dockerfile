...
RUN apt-get -y update && \
    # tools
    apt-get install -y vim git subversion wget curl tree net-tools locales iputils-ping traceroute firefox firefox-locale-zh-hans ttf-wqy-microhei gedit ibus-pinyin && \
